...
class ParquetTableWriter:
    ...
    def write_table(
        ...
        *,
        ...
        if table_name.casefold().startswith("curated") and any(
            row.get("layer") in {"staging", "normalized", "audit", "quarantine"}
    ...
    def write_normalized_tables(
        ...
        *,
        ...
        return (
            self.write_table("staging", staging, schema_version=schema_version),
            self.write_table("audit", audit, schema_version="audit.v1"),
            self.write_table("quarantine", quarantine, schema_version="quarantine.v1"),
        )
